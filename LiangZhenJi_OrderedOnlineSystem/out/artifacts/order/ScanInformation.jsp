...
<body>
    <section id="all">
            ...
            <section id="loading_div">
                            <h1>我的信息</h1>
                        <p id="img">头像:&nbsp<img src=<%=request.getAttribute("personPhoto") %> alt="" width="100px" height="100px" ><br></p>
                        <p id="infor">用户名:&nbsp<%=session.getAttribute("userName") %><br></p>
                        <p id="infor">密码:&nbsp<%=request.getAttribute("password") %><br></p>
                        <p id="infor">性别:&nbsp <%=request.getAttribute("sex") %><br></p>
                        <p id="infor">支付密码:<%=request.getAttribute("payPassword") %><br></p>
                        <p id="infor">地址:&nbsp<%=request.getAttribute("address") %><br></p>
                        <a href="UpdateInformation.jsp"><input id="btn1" type="button" value="修改信息"  ></a>
