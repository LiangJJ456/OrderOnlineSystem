...
<body>
    <section id="all">
            ...
            <section id="loading_div">
                    <form  id= "loading_form" action="OpenShopVeiw" onsubmit="return validate()"enctype="multipart/form-data"  method="post" >
                      <h1 >提交开店信息</h1>  
                        店铺名称:&nbsp<input type="text" name="shopName" class="form1" ><br>
                        店铺图片:&nbsp<input type="file" name="shopNhoto" class="form1" ><br>
    ...
    <script>
            ...
            function validate(){
        	  ...
        	  var shopphoto=document.getElementsByName('shopPhoto')[0];
                if(shopname.value==''){
