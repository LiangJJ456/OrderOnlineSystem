...
<body>
    <section id="all">
            ...
            <section id="loading_div">
                    <form  id= "loading_form" action="UpdateInformationVeiw" onsubmit="return validate()" enctype="multipart/form-data"  method="post" >
                        ...
                        <input id="btn1" type="submit" value="确定修改"  >
                    </form>
            </section>
    </section>
    <script>
