...
/**
 * Servlet implementation class GoodsWellReputedVeiw
 */
@WebServlet("/GoodsWellReputedVeiw")
public class GoodsWellReputedVeiw extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GoodsWellReputedVeiw() {
        super();
