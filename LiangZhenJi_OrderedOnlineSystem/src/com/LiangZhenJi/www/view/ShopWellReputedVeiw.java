...
/**
 * Servlet implementation class ShopWellReputedVeiw
 */
@WebServlet("/ShopWellReputedVeiw")
public class ShopWellReputedVeiw extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShopWellReputedVeiw() {
        super();
